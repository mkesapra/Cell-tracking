...
frames = pims.open('/Users/kesaprm/FY19_20/Spring2020/Project/FS-Tracer_Data/No EF1/c1/s0/*.tif')
#frames = pims.open('/Users/kesaprm/Desktop/BaxterAlgorithms-master/New_48_Ms/M0_BG/*.tif')
...
for k in t1.particle.unique():
    curr_cell_x = t1.x[t1.particle == k]*(1/2.155)
    curr_cell_y = t1.y[t1.particle == k]*(1/2.155)
    rel_x = []; rel_y =[];
