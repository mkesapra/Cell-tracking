...
# -*- coding: utf-8 -*-
"""
Created on Fri Sep 24 14:48:14 2021
...
frames = pims.open('/Users/kesaprm/Desktop/BaxterAlgorithms-master/New_48_Ms/M1_BG/*.tif')
...
f = tp.locate(frames[0],71,invert=True,minmass=4*1e3)
tp.annotate(f, frames[0], plot_style={'markersize':12})
...
f = tp.batch(frames[:], 71, invert=True,minmass=4*1e3);
